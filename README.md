...
- [Asincronismo-con-JavaScript](#asincronismo-con-javascript)
  ...
  - [Qué es asincronismo](#qué-es-asincronismo)
      - [- JavaScript es single-threaded:](#--javascript-es-single-threaded)
  ...
  - [Event loop](#event-loop)
      - [- Event loop:](#--event-loop)
      - [- Memory Head:](#--memory-head)
      - [- Call Stack _(pila)_:](#--call-stack-pila)
      - [- Task Queue:](#--task-queue)
      - [- Micro Task Queue:](#--micro-task-queue)
      - [- Web APIs:](#--web-apis)
      - [- Conclusion Event Lopp:](#--conclusion-event-lopp)
